package com.example.springbootprometheusdocker.prometheusScheduler;
...
public class PrometheusScheduler {
    ...
    public PrometheusScheduler(MeterRegistry meterRegistry) {
    ...
    public void schedulingTask() {
        testGauge.set(PrometheusScheduler.getRandomNumberInRange(0, 100));
